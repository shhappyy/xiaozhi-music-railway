...
async function main() {
  ...
  console.log('Initializing Xiaozhi MCP...');
      await call(xiaozhiWs, 'initialize', { protocolVersion: '2024-11-05', capabilities: {}, clientInfo: { name: 'music-bridge', version: '1.0.0' } });
      send(xiaozhiWs, { jsonrpc: '2.0', method: 'notifications/initialized' });
      console.log('Xiaozhi MCP initialized');
